#!/usr/bin/env python3
"""
Database Configuration Template for HES-Kaifa Events
Copy this file to database_config.py and update with your database settings
"""
...
class DatabaseConfig:
    ...
    def __init__(self):
        ...
        self.host = os.getenv('DB_HOST', 'localhost')  # Change to your database host
        self.port = int(os.getenv('DB_PORT', '5432'))
        self.database = os.getenv('DB_NAME', 'hes_kaifa_events')  # Change to your database name
        self.user = os.getenv('DB_USER', 'hes_app_user')  # Change to your database user
        self.password = os.getenv('DB_PASSWORD', 'secure_password')  # Change to your database password
